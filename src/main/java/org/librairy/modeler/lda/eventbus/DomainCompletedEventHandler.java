 ...
 */
@Component
public class DomainCompletedEventHandler implements EventBusSubscriber {

    private static final Logger LOG = LoggerFactory.getLogger(DomainCompletedEventHandler.class);
    ...
    @PostConstruct
    public void init(){
        BindingKey bindingKey = BindingKey.of(RoutingKey.of("domain.pending"), "modeler.lda.domain.completed");
