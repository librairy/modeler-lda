 ...
 */
@Component
public class DocAddedEventHandler implements EventBusSubscriber {

    private static final Logger LOG = LoggerFactory.getLogger(DocAddedEventHandler.class);
    ...
    public void handle(Event event) {
        ...
        try{
            ...
            String documentUri      = relation.getEndUri();
