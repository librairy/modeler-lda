 ...
 */
@Component
public class EvaluationsCache {

    private static final Logger LOG = LoggerFactory.getLogger(EvaluationsCache.class);
                ...
                .build(
                        new CacheLoader<String, Integer>() {
                            public Integer load(String domainUri) {
                                Optional<String> parameter = parametersDao.get(domainUri, "lda.max.evaluations");
    ...
    public Integer getEvaluations(String domainUri)  {
        try {
