 ...
 */
@Component
public class ParamBetaCache {

    private static final Logger LOG = LoggerFactory.getLogger(ParamBetaCache.class);
                ...
                .build(
                        new CacheLoader<String, Double>() {
                            public Double load(String domainUri) {
                                Optional<String> parameter = parametersDao.get(domainUri, "lda.beta");
